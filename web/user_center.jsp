<%--在访问该页面之前必须先登录，若无登录，则跳转访问index.jsp页面--%>
...
<%--代码存疑--%>
	<%--没有事先登录，则重定向到indexServl--%>
	<c:if test="${empty user}"><%response.sendRedirect("${pageContext.request.contextPath}/index");%></c:if>
	<!--account-->
	<div class="account">
		<div class="container">
			<div class="register">
				...
				<c:if test="${!empty failMsg }">
					...
					<div class="register-top-grid">
						...
						<div class="register-but text-center">
						   <input type="submit" value="提交"><%--提交异常404--%>
						</div>
						<!-- 收货信息 end -->
						</form>
						<hr>
